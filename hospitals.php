...
<!-- Header Start -->
   ...
   $startpoint = ($page * $perpage) - $perpage;
	        ...
	        $mypaint = $db->questViewPage($perpage, $startpoint, $sts);
		    $num = $db->questViewPage($perpage,$startpoint,1);  // count
            $rows = $db->questViewPage($perpage,$startpoint,2); // array
						if($num > 0)
								{
								$i=0;
				...
				?>
					...
					<?php
                               ...
                               <div class="row">&nbsp;</div>
                                <?php 
								echo $db->Pages($sql_daily,$perpage,"hospitals.php?"); 
								?>
