                        ...
                        <div class="col-md-3 center">
                            <div class="login-box">
                                ...
                                <form class="m-t-md"  method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <input type="file" class="form-control" placeholder="Contact Number" name="A1" >
                                    </div>
                                    <div class="form-group">
                                        <textarea name="details" class="form-control" placeholder="Extra Details"   rows="5"></textarea>
                                    </div>
                                    <button type="submit" class="btn btn-success btn-block" name="btn">Register</button>
